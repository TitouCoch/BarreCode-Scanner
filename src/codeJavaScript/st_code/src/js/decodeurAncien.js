...
const decodeur = {
  recuperationContourObjets: function(uneMatriceImage) {
  ...
  recuperationRatio: function(matriceContourObjet) {
  ...
  conversionGrayCode: function(listeRatios) {
  ...
  conversionLicence: function(licenceGreyCode) {
  ...
  testerLicense: async function (numLicence)
  {
