...
boutonPhoto.addEventListener('click', () => {
  ...
  /*while (sortie!='true') {
    try {*/
      ...
      var uneListeRatios = new ListeRatios(recuperationRatio(desContoursObjets.getContoursObjets()));
      ...
      testerLicence(uneLicence).then((n) => {console.log(n); sortie = n });
    /*}
    catch (e) {
      // s'il y a une erreur, on met sortie a false 
      sortie = false;
    }
  }*/
